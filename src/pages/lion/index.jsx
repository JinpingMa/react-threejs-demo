...
const LionModel = () => {
    ...
    const generatorModel = () => {
        ...
        Lion.prototype.look = function(xTarget, yTarget) {
            ...
            for (var i=0; i<this.bodyVertices.length; i++){
                ...
                var tv = this.body.geometry.vertices[this.bodyVertices[i]];
                if (tv) tv.x = tvInit.x + this.head.position.x;
            }
    ...
    return (
        <>
            <div id="world" ref={canvasRef}/>
            <div id="instructions">Press and drag to make wind<br/><span className={styles.lightInstructions}>the lion will surely appreciate</span>
            </div>

            <div id="credits">
                <p>Prints on <a className={styles.society6} href="https://society6.com/yakudoo/"
                                target="blank">society6</a> | <a
                    href="https://codepen.io/Yakudoo/" target="blank">my other codepens</a> | <a
